...
import { Archive, ArchiveRestore, Trash2, Pencil, Check, X, FolderOpen } from "lucide-react";
    ...
    <div className="min-h-screen w-full">
      ...
      >
        ...
        {isAuthenticated && (
          ...
          >
            <div className="px-4 py-3" style={{ background: dayLabelColor }}>
            <label
            ...
            <div className="flex items-center gap-2 p-4">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-lg bg-secondary text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent text-sm"
          ...
          {isLoading ? (
            ...
            <div className="divide-y" style={{ borderColor: "var(--border)" }}>
              {activeProjects.map((project) => (
                <div
                  key={project.id}
                  className="group flex items-center gap-3 px-4 py-3 transition-colors cursor-pointer hover:bg-secondary/50"
