...
import { MODE_OKLCH, MODE_TINT, MODE_CARD_BG, MODE_SOLID, PRIORITY_EXCLAIM } from "../../../shared/types";
...
function OrbTaskRow({ task, modeColor, expanded, onExpand, onToggleComplete, onTogglePin, onEdit, onDelete }: OrbTaskRowProps) {
  ...
  return (
    <div
      ...
      style={{
        background: MODE_CARD_BG[task.mode as TaskMode] ?? MODE_TINT[task.mode as TaskMode] ?? "var(--color-card)",
        border: "none",
        color: "#fff",
