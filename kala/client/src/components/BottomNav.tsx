...
const EXPLORE_ITEMS = [
  { path: "/profection", label: "Profection", icon: Orbit },
  { path: "/dasha", label: "Dasha", icon: Star },
        ...
        <div className="flex items-stretch justify-around max-w-lg mx-auto">
          {PRIMARY_NAV.map(({ path, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                  ...
                  style={active ? { filter: "drop-shadow(0 0 6px var(--border))" } : {}}
                />
                <span
                ...
                {active && (
                  <span className="absolute bottom-0 w-6 h-0.5 rounded-full" style={{ background: "var(--foreground)", boxShadow: "0 0 8px var(--border)" }} />
                )}
              </button>
            );
          })}
          ...
          >
            <MoreHorizontal
              ...
              style={isExplorePath || exploreOpen ? { filter: "drop-shadow(0 0 6px var(--border))" } : {}}
            />
            <span
              className="text-[10px] font-medium tracking-wide uppercase"
              style={{ letterSpacing: "0.04em" }}
