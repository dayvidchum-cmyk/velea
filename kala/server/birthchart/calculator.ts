...
export interface BirthChartResult {
  // UTC birth moment for verification
  utcBirthIso: string;
  // Julian Day used
  julianDay: number;
  lagna: { sign: string; degree: number; longitude: number };
  sun: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  moon: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  mercury: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  venus: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  mars: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  jupiter: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  saturn: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  rahu: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
  ketu: { sign: string; degree: number; longitude: number; house: number; nakshatra: string; pada: number };
}
...
export async function calculateBirthChart(
  ...
  // Use sidereal flag — Swiss Ephemeris returns sidereal coordinates directly
