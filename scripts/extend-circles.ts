 ...
 *
 * Final roster (15): life_partner · children · family · inner_circle · friends ·
 * acquaintances · mentors · mentees · coworkers · clients · followers · pets ·
 * enemies · self · everyone_else
 *
...
const FINAL = "'life_partner','children','family','inner_circle','friends','acquaintances','mentors','mentees','coworkers','clients','followers','pets','enemies','self','everyone_else'";
...
async function run() {
  ...
  console.log("✅ tasks.circle is the final fifteen — data preserved, best_friends folded in.");
  process.exit(0);
}
