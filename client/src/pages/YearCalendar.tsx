                        ...
                        return (
                          <button key={ds} onClick={() => setDayPopup({ ds, d })}
                            ...
                            style={{ background: bg, color: filled || isPicked ? shade(coin) : familyInk,
                              ...
                              border: isCrown ? "1.5px solid #D4AF37"
                            ...
                            {(() => {
                              /* YEAR TILES ONLY (David 2026-07-16): "THOSE crowns can stay big
                                 and fat and alone in the rectangles" — the border-riding law is
