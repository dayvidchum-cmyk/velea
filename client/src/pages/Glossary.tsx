...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "The Meridian (voice axis)", category: "Chart", definition: "The MC–IC axis read as one line: your outer voice (the Midheaven — what you're called to say and build) balanced by your inner voice (the Imum Coeli — the ground you speak from). Velea reads it in the real sidereal sign, which Western misses." },
