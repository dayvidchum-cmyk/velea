...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Pancha Pakshi", category: "Concepts", definition: "A South-Indian (Tamil) 'five birds' timing system that scores every stretch of the day as favorable or unfavorable. Your birth star assigns you one of five birds; then the weekday, the moon's fortnight (paksha), and the time of day set which bird is active and in what state — an hour-by-hour good/bad map. In Velea this powers Master Mode." },
