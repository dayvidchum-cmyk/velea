...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Selective", category: "Modes", definition: "Advance, don't initiate. The day favors moving existing threads forward — warm connections, live conversations, follow-ups — not brand-new fronts. Best for: following up on warm connections, active conversations, advancing work already in motion, finishing one thing. Ease off: cold starts, opening many new fronts, broad untargeted outreach." },
  ...
  { term: "Mars (Mangala)", category: "Planets", definition: "Energy, courage, drive, and conflict — the warrior and army-commander (senapati). Mars governs action, ambition, discipline, competition, siblings and your close circle, and physical strength. Rules Aries and Scorpio; exalted in Capricorn, debilitated in Cancer. A natural malefic; its placement shows where you assert and where you fight." },
