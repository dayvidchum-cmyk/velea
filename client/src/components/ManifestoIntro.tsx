        ...
        {i < BEATS.length ? (
          <div key={i} style={{ animation: "velea-rise 0.7s ease both" }}>
            {BEATS[i].lines.map((ln, k) => (
              <p key={k} style={{ fontSize: k === 0 ? "1.55rem" : "1.25rem", lineHeight: 1.5, color: "rgba(255,255,255,0.9)", margin: k ? "1.1rem 0 0" : 0, fontWeight: k === 0 ? 700 : 400 }}>
                <Line text={ln} />
              </p>
            ))}
          </div>
          ...
          <div key="thesis" style={{ animation: "velea-rise 0.7s ease both" }}>
            <p style={{ fontSize: "1.35rem", fontWeight: 700, color: "#FDFDFD", lineHeight: 1.35, margin: 0 }}>
            ...
            <p style={{ fontSize: "1.3rem", fontWeight: 700, color: "#FDFDFD", margin: "1.5rem 0 0", letterSpacing: "0.02em" }}>
